...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `project3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `project` VALUES (1,'쇼핑몰오픈',100,'매우중요'),(2,'뉴스서비스오픈',100,'보통'),(3,'OAuth서버',85,'중요'),(4,'CMS도입',80,'중요'),(5,'쇼핑몰v2',75,'보통'),(6,'뉴스서비스v2',60,'중요'),(7,'SSO구현',55,'매우중요'),(8,'CMSv2',40,'보통'),(9,'쇼핑몰v3',30,'보통'),(10,'보안시스템v1',10,'매우중요');
...
-- Dump completed on 2024-06-17 10:43:06
